...
- **Remover redundâncias da tabela** `Itens` (não precisa repetir `ID_Cliente` e `Data_Venda`).
...
| Devolucoes  | Id_Item	               | Identificador único de cada item                                                                                                								   | int         |
...
| Itens       | Id_Item				   | Identificador único do item                                                                                                                                       | int         |
